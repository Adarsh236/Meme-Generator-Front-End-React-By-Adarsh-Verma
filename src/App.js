...
class App extends Component {
    constructor(props) {
        ...
        this.cl = cloudinary
            .Cloudinary
            .new({cloud_name: 'christekh'})
        this.uploadWidget = window
            .cloudinary
            .createUploadWidget({
        ...
        // rebind context
        this.initiateUpload = this
            .initiateUpload
            .bind(this);
        this.transformToMeme = this
            .transformToMeme
            .bind(this);
        this.handleTopTextChange = this
            .handleTopTextChange
            .bind(this);
        this.handleBottomTextChange = this
    ...
    makeMeme = () => {
        ...
        fetch('https://meme-generator-backend.herokuapp.com/image', {
            method: 'put',
            headers: {
                                            ...
                                            <div className="meme-box column">
                                                {
                                                    stage !== 'PVR'
                                                        ? (
                                                            <button onClick={this.initiateUpload} className="button is-info is-margin-top">
                                                                Upload
                                                            </button>
                                                        )
